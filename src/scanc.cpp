 ...
 * @brief Funções para class scand -> SCAN considerando o bit de sentido como SOBE
 * @version 0.1
 * @date 2018-11-28
 * 
...
/**
 * @brief Construct a new scanc::scanc object
 * 
 * @param Disco_ Estatus inicial do disco
 */
scanc::scanc(disco Disco_){
...
void scanc::resolvendo(void){
    ...
    render imprimir_("SCAN SOBE", ordem_acessada, jornada_total);
    imprimir_.print();
}